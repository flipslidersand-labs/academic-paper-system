...
def save_paper(conn: sqlite3.Connection, file_name: str, file_hash: str, **kwargs) -> int:
...
def search_fts(conn: sqlite3.Connection, query: str, limit: int = 10, paper_id: int | None = None) -> list[dict]:
