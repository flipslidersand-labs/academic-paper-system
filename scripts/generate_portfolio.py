...
# GITHUB_REPOSITORY is set automatically in Actions runs; the constant fallback
# covers local/manual runs so this doesn't go stale on the next org move (#434).
REPO = os.environ.get("GITHUB_REPOSITORY", "flipslidersand-labs/academic-paper-system")
...
<body class="bg-gray-50 min-h-screen font-sans text-gray-800">
  ...
  <footer class="text-center text-xs text-gray-300 py-8">
    Generated by <a href="https://github.com/{REPO}" class="hover:underline">academic-paper-system</a>
  </footer>
</body>
</html>
"""
